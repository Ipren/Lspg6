...
void Animator::AssignSkinnedMesh(string meshName)
{
	...
	this->_mesh = MeshContainer::skinnedMeshes[meshName];
	this->skinned_vs = MeshContainer::skinned_vs;
	this->skinned_ps = MeshContainer::skinned_ps;
	this->skinned_layout = MeshContainer::skinned_layout;
	this->currentClip = &this->_mesh->animations["idle"];
	this->mesh = _mesh->mesh;
