...
void Renderer::createBlurPass()
{
	...
	tex_desc.MiscFlags = 0;// D3D11_RESOURCE_MISC_GENERATE_MIPS;
	...
	DXCALL(gDevice->CreateShaderResourceView(blurtex[0], &sdesc, &mip_start));
	...
	for (int i = 0; i < 10; ++i) {
		...
		DXCALL(gDevice->CreateShaderResourceView(blurtex[0], &sdesc, &mip_srv[i]));
		DXCALL(gDevice->CreateRenderTargetView(blurtex[0], &rdesc, &mip_rtv[i]));
	}
...
void Renderer::createMapResurces()
{
	...
	TriangleVertex triangleVertices[6] =
	{
		10.f, -0.1f, -10.f, 1.0f,	//v0 pos
		1.0f, 1.0f,

		-10.f, -0.1f, -10.f, 1.0f,	//v1
		0.0f, 1.0f,

		-10.f, -0.1f, 10.f, 1.0f, //v2
		0.0f,  0.0f,

		//t2
		-10.f, -0.1f, 10.0f, 1.0f,//v0 pos
		0.0f, 0.0f,

		10.f, -0.1f, 10.0f, 1.0f,//v1
		1.0f, 0.0f,

		10.f, -0.1f, -10.0f, 1.0f,//v2
		1.0f, 1.0f
	};
	...
	{
		49.5f, -0.19f, -49.5f, 1.0f,	//v0 pos
		1.0f, 1.0f,

		-49.5f, -0.19f, -49.5f, 1.0f,	//v1
		0.0f, 1.0f,

		-49.5f, -0.19f, 49.5f, 1.0f, //v2
		0.0f,  0.0f,
...
void Renderer::renderMips()
{
	...
	for (int i = -1; i < 9; ++i) {
		...
		int mipw, miph;
		GetMipLevelSize(WIDTH, HEIGHT, i + 2, mipw, miph);
